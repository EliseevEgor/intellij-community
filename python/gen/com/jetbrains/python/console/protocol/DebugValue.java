...
public class DebugValue implements org.apache.thrift.TBase<DebugValue, DebugValue._Fields>, java.io.Serializable, Cloneable, Comparable<DebugValue> {
  ...
  public java.lang.String qualifier; // required
  public java.lang.String value; // required
  public boolean isContainer; // required
  public java.lang.String shape; // required
  ...
  public DebugValue setName(java.lang.String name) {
    this.name = name;
    return this;
  }
  ...
  public DebugValue setType(java.lang.String type) {
    this.type = type;
    return this;
  }
  ...
  public DebugValue setQualifier(java.lang.String qualifier) {
    this.qualifier = qualifier;
    return this;
  }
  ...
  public DebugValue setValue(java.lang.String value) {
    this.value = value;
    return this;
  }
  ...
  public DebugValue setShape(java.lang.String shape) {
    this.shape = shape;
    return this;
  }
  ...
  public int compareTo(DebugValue other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetIsContainer()).compareTo(other.isSetIsContainer());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIsContainer()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetShape()).compareTo(other.isSetShape());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetShape()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetIsReturnedValue()).compareTo(other.isSetIsReturnedValue());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetIsIPythonHidden()).compareTo(other.isSetIsIPythonHidden());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetIsErrorOnEval()).compareTo(other.isSetIsErrorOnEval());
    if (lastComparison != 0) {
      return lastComparison;
    }
